                  ...
                  children: [
                    ...
                    Flexible(
                      ...
                      child: Padding(
                          ...
                          child: TextFormField(
                            initialValue: (geburtsjahr == 0) ? null : geburtsjahr.toString(),
                    ...
                    Flexible(
                        ...
                        child: Padding(
                            ...
                            child: DropdownButtonFormField(
                              ...
                              items: <String>["Keine Angabe", "Rasant", "Gemütlich", "Anpassungsfähig"]
                                  .map<DropdownMenuItem<String>>((String value) {
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: (value == "Keine Angabe")
                                      ? Text(value, style: TextStyle(fontStyle: FontStyle.italic, color: grey))
                                      : Text(value),
                                );
                              }).toList(),
                            )))
                    ...
                    Flexible(
                        ...
                        child: Padding(
                            ...
                            child: DropdownButtonFormField(
                              ...
                              items: <String>["Keine Angabe", "Weiblich", "Männlich", "Divers"]
                                  .map<DropdownMenuItem<String>>((String value) {
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: (value == "Keine Angabe")
                  ...
                  child: ElevatedButton(
                      onPressed: () async {
                        if (formKey.currentState!.validate()) {
                          ...
                          bool usernameFree = await SQL().isUsernameFree(username);
                          SharedPreferences prefs = await SharedPreferences.getInstance();
                          Navigator.of(context).pop();
                          if (usernameFree || prefs.getString('username') == username) {
                                ...
                                Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                          ...
                                          child: Text('Dieser Benutzername ist bereits vergeben',
