...
class _RegisterState extends State<Register> {
  ...
  String password = "";
  String wohnort = "";
  DateTime geburtsjahr = DateTime(1900);
...
class RegisterRow extends StatelessWidget {
  const RegisterRow(
      {Key? key, required this.label, this.validator, required this.onSaved})
      : super(key: key);
  final String label;
    ...
    return Row(
      ...
      children: [
        ...
        Flexible(
          ...
          child: Padding(
              padding: EdgeInsets.only(left: 15),
              child: TextFormField(validator: validator, onSaved: onSaved)),
        )
      ],
    );
  }
